...
<head>
    ...
    <title>Página no encontrada | FutGo</title>
...
<body class="min-h-screen bg-slate-50 dark:bg-dark-950 flex items-center justify-center px-4">
    <div class="text-center max-w-md">
        ...
        <div class="relative mb-6 inline-block">
            <div class="text-[120px] font-black text-slate-100 dark:text-white/5 leading-none select-none">404</div>
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="w-24 h-24 rounded-3xl bg-brand-500/10 border-2 border-brand-500/20 flex items-center justify-center">
                    <i class="ph-fill ph-soccer-ball text-brand-500 text-5xl"></i>
                </div>
            </div>
        </div>

        <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">¡Se fue la pelota!</h1>
        <p class="text-slate-500 dark:text-slate-400 text-sm mb-8 leading-relaxed">
            La página que buscás no existe o fue movida. Pero tranquilo, todavía podés encontrar tu cancha.
        </p>
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="/canchas"
               class="flex items-center justify-center gap-2 px-6 py-3 rounded-2xl border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 font-semibold hover:border-brand-500 hover:text-brand-500 transition-colors">
                <i class="ph-bold ph-magnifying-glass"></i> Buscar canchas
            </a>
        </div>
